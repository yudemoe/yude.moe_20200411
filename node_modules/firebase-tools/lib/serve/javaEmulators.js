...
const EmulatorDetails = {
    ...
    firestore: {
        ...
        stdout: null,
        cacheDir: CACHE_DIR,
        remoteUrl: "https://storage.googleapis.com/firebase-preview-drop/emulator/cloud-firestore-emulator-v1.4.6.jar",
        expectedSize: 57215639,
        expectedChecksum: "e0ace9e2b73a3334f9094fca06b93abc",
        localPath: path.join(CACHE_DIR, "cloud-firestore-emulator-v1.4.6.jar"),
    },
};
const Commands = {
    database: {
...
exports.start = start;
//# sourceMappingURL=javaEmulators.js.map